        ...
        Optional<Store> result = storeRepository
            ...
            .map(existingStore -> {
                if (store.getTitle() != null) {
                    existingStore.setTitle(store.getTitle());
                }
                if (store.getInfo() != null) {
                    existingStore.setInfo(store.getInfo());
                }
                if (store.getAddress() != null) {
                    existingStore.setAddress(store.getAddress());
                }
                if (store.getDateAdded() != null) {
                    existingStore.setDateAdded(store.getDateAdded());
                }
                if (store.getDateModified() != null) {
                    existingStore.setDateModified(store.getDateModified());
                }
